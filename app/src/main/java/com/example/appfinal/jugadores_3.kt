...
class jugadores_3 : AppCompatActivity(), OnFragmentActionsListener {
    private lateinit var binding: ActivityJugadores3Binding
    var intentos=0

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding=ActivityJugadores3Binding.inflate(layoutInflater)
    ...
    private fun roll() {
        ...
        plantarse.setOnClickListener {
            comprobarvalores1(num_jugador_1,num_jugador_2,num_jugador_3,num_carta1)
        }
    ...
    private fun comprobarvalores1(valor1:Int, valor2:Int, valor3:Int, cartajug1:String){
        var value2=valor2
        var value3=valor3
        ...
        while (num_carta2==cartajug1 || num_carta3==cartajug1 || num_carta2==num_carta3){
