...
class jugadores_2 : AppCompatActivity(),OnFragmentActionsListener {
    private lateinit var binding: ActivityJugadores2Binding
    var intentos=0

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding=ActivityJugadores2Binding.inflate(layoutInflater)
    ...
    private fun roll() {
        ...
        plantarse.setOnClickListener {
            comprobarvalores(num_jugador_1,num_jugador_2,num_carta1)
    ...
    private fun comprobarvalores(valor1:Int, valor2:Int, cartajug1:String){
        var value2=valor2
